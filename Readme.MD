...
- **Real Embeddings**: Sentence-transformers (all-mpnet-base-v2) with GPU acceleration
- **Semantic Understanding**: pgvector-powered similarity search with 768-dimensional embeddings
